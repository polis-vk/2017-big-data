...
public class TopNames extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        final Job job = new Job(conf, "TopNames");

        valueNumber = Integer.valueOf(args[2]);

        job.setJarByClass(TopNames.class);
    ...
    public static void main(String[] args) throws Exception{
        final int returnCode = ToolRunner.run(new Configuration(), new TopNames(), args);
